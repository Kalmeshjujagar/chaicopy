...
const Hero = () => {
  ...
  return (
    <div className="pb-20 pt-36">
      <div>
        <Spotlight
          className="-top-50 -left-10 md:-left-32 md:-top-20 h-[90vh] w-[50vw]"
          fill="white"
        />
        <Spotlight className="h-[90vh] w-[50vw] top-50 left-full" fill="pink" />
      ...
      <div className="flex justify-center relative my-20 z-10">
        <div className="max-w-[89vw] md:max-w-2xl lg:max-w-[60vw] flex flex-col items-center justify-center">
          <p className="uppercase tracking-widest text-xs text-center text-blue-100 max-w-90">
            Innovating with Modern JavaScript Frameworks
          </p>
          ...
          <p className="text-center md:tracking-wider mb-4 text-sm md:text-lg lg:text-2xl">
            Hi! I&apos;m Kalmesh, a Next.js Developer based in India.
          </p>
